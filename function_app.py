...
@app.blob_trigger(arg_name="myblob", path="raw-files/{name}",
                               connection="AzureWebJobsStorage") 
def BlobCSVProcessor(myblob: func.InputStream):
...
# @app.blob_trigger(arg_name="client", path="raw-files/{name}",
#                   connection="AzureWebJobsStorage")
# def BlobCSVProcessor(client: blob.BlobClient):
#     logging.info(
